...
class CommentWidget extends StatefulWidget {
  ...
  const CommentWidget(
      {super.key, required this.comment, required this.article});
        ...
        children: [
          Row(
            children: [
              ...
              Text(DateTimeHelper.indDateString(comment.dateTimeCommented)
        ...
        child: Column(
          ...
          children: [
            Row(mainAxisSize: MainAxisSize.min,
              children: [
                Text(widget.reply.user!, style: const TextStyle(fontWeight: FontWeight.bold,
                    fontSize: 16)),
                const SizedBox(width: 16),
                Text(DateTimeHelper.indDateString(widget.reply.dateTimeReplied)
                  , style: TextStyle(fontSize: 16),),
              ],
            ),
            const SizedBox(height: 8),
