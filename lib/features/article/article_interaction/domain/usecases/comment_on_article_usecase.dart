...
class CommentOnArticleUseCase extends Usecase<Success, ArticleInteractionParams> {

  final ArticleInteractionRepository repository;

  CommentOnArticleUseCase(this.repository);

  @override
  Future<Either<Failure, Success>> call(ArticleInteractionParams params)  async {

    return await repository.commentOnArticle(params);
  }
